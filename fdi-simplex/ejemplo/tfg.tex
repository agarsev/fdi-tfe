...
% Para cambiar la fuente principal (solo LuaLaTeX/XeLaTeX), añade esta línea:
% \setmainfont{TeX Gyre Pagella}   % o cualquier otra fuente OpenType instalada
...
\begin{contribucion}{Ana García López}
...
\begin{contribucion}{Bruno Martín Ruiz}
